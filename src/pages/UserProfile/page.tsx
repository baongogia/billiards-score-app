...
export default function UserProfile() {
  ...
  const handleFileChange = async (
    ...
    formData.append("upload_preset", "Bidaapp");

    try {
      const response = await fetch(
        "https://api.cloudinary.com/v1_1/dqajj5zd1/image/upload",
        {
          method: "POST",
          body: formData,
        }
      ...
      >
        <div className="profile-card js-profile-card">
          ...
          <div
            ...
            className="absolute top-10 left-[55%] z-10 cursor-pointer"
          >
            <div className="w-8 h-8 bg-blue-400 flex justify-center items-center rounded-full">
              <div className="ml-1">
                <FaUserPen size={20} color="black" />
              </div>
            </div>
          </div>
          ...
          <div className="profile-card__cnt js-profile-cnt">
            <div className="profile-card__name">{auth?.user?.email}</div>
            <div className="profile-card__txt">
              <strong>VIETNAM</strong> Billiards club member
            </div>
            ...
            <div className="profile-card-inf">
              <div className="profile-card-inf__item">
                <div className="profile-card-inf__title">278</div>
                <div className="profile-card-inf__txt">Matchs</div>
              </div>

              <div className="profile-card-inf__item">
                <div className="profile-card-inf__title">65</div>
                <div className="profile-card-inf__txt">Win</div>
              </div>

              <div className="profile-card-inf__item">
                <div className="profile-card-inf__title">123</div>
                <div className="profile-card-inf__txt">Draw</div>
              </div>

              <div className="profile-card-inf__item">
                <div className="profile-card-inf__title">85</div>
                <div className="profile-card-inf__txt">Lose</div>
              </div>
            </div>
